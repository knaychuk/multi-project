...
const DarkLightMode = () => {
  ...
  return (
    <div className={colorTheme}> 
      <Navbar navTheme={navTheme} linkUrl={'About'} linkText1={'About'}/>
      ...
      <footer className={`${navTheme} px-10 py-20`}>
      <h2 className="text-xl mb-5">Attributions</h2>
      <div className="flex flex-col">
        <a className={`mt-2 hover:underline`} href="https://www.flaticon.com/free-icons/light-mode" title="light mode icons">Light mode icons created by bsd - Flaticon</a>
        <a className='mt-2 hover:underline' href="https://www.flaticon.com/free-icons/dark" title="dark icons">Dark icons created by Freepik - Flaticon</a>
